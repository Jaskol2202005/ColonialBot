...
module.exports = {
  ...
  execute(message, args) {
    ...
    } else if (args[0] === `add` && message.channel.id === `715038247964639282` || args[0] === `add` && message.channel.id === `783067630072234014`) {
      args.shift()
      let nextOperation = ''
    ...
    } else if (args[0] === `remove` && message.channel.id === `715038247964639282` || args[0] === `remove` && message.channel.id === `783067630072234014`) {
      args.shift()
    ...
    } else if (args.length === 0 && message.channel.id === `715038247964639282` || args.length === 0 && message.channel.id === `783067630072234014`) {
      let reply = 'Current operations:'
      let currentOperations = nconf.get(`currentOperations`)
      if (currentOperations.length === 0) {
        reply = `No operations are currently set`
