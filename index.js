...
client.once('ready', () => {
  ...
  client.api.applications(client.user.id).commands.post({
    data: {
      ...
      options: [
        {
          name: "commander",
          description: "commander you want to look up",
          type: 3,
          required: true
        }
      ]
  ...
  client.api.applications(client.user.id).commands.post({
    data: {
      ...
      options: [
        {
          name: "faction",
          description: "Faction you want to look up",
          type: 3,
          required: true
        }
      ]
  ...
  client.api.applications(client.user.id).commands.post({
    data: {
      name: "factions",
      description: "Looks for faction details in a specified system",
      options: [
        {
          name: "system",
          description: "System's factions you want to look up",
          type: 3,
          required: true
        }
      ]
