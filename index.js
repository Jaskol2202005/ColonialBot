  ...
  db.get("ignoreList").then(value => {
    ...
    db.get("currentOperations").then(value => {
      ...
      for (var i = 0; i < currentOperations.length; i++) {
        ...
        if (pos !== -1) {
        } else if (message.content.includes(`${currentOperations[i]} `) || message.content.includes(`${currentOperationsUpperCase} `) || message.content.includes(` ${currentOperations[i]}`) || message.content.includes(` ${currentOperationsUpperCase}`) || message.content.includes(` ${currentOperations[i]}.`) || message.content.includes(` ${currentOperationsUpperCase}.`) || message.content.includes(` ${currentOperations[i]},`) || message.content.includes(` ${currentOperationsUpperCase},`) || message.content.includes(`${currentOperations[i]}`) && message.content.length === currentOperations[i].length || message.content.includes(`${currentOperationsUpperCase}`) && message.content.length === currentOperationsUpperCase.length) {
